		...
		<div className={classes.container}>
			<div className={classes.tweetCard}>
				...
				<div className={classes.tweetCardReply}>
					...
					<span>
						{!tweetInfo.isLiked && <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						{tweetInfo.isLiked && <svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
